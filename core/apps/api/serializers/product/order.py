...
from core.apps.api.models.product import OrderitemsModel
from core.apps.api.serializers.product.orderitems import CreateOrderitemsSerializer
...
class CreateOrderSerializerV2(BaseOrderSerializer):
    items = CreateOrderitemsSerializer(many=True)
